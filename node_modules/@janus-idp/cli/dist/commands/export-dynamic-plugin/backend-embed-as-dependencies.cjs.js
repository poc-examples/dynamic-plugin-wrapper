...
throw new Error(
  ...
  if (opts.install) {
    ...
    const yarnInstall = version.startsWith("1.") ? `${yarn} install --production${yarnLockExists ? " --frozen-lockfile" : ""} ${redirect}` : `${yarn} install${yarnLockExists ? " --immutable" : " --no-immutable"} ${redirect}`;
...
function validatePluginEntryPoints(target) {
  ...
  function requireModule(modulePath) {
    try {
      ...
      if (e?.name !== SyntaxError.name || dynamicPluginRequire.extensions[".ts"] !== void 0) {
        throw e;
      }
    }
    tasks.Task.log(
...
//# sourceMappingURL=backend-embed-as-dependencies.cjs.js.map
