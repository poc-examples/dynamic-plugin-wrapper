 ...
 * @enum {string}
 */
export declare enum RemedyTypeEnum {
...
export declare enum ClassTypeDef {
...
export declare enum ProblemTypeDef {
    Rule = "rule",
...
export declare enum ResolutionTypeDef {
 ...
 * @enum {string}
 */
export declare enum IssueAttributesEffectiveSeverityLevelEnum {
    Info = "info",
    Low = "low",
    Medium = "medium",
    High = "high",
 ...
 * @enum {string}
 */
export declare enum IssueAttributesStatusEnum {
    Open = "open",
    Resolved = "resolved"
}
...
export declare enum ScanItemType {
    Project = "project",
...
export declare enum TestExecutionType {
...
//# sourceMappingURL=unifiedIssuesTypes.d.ts.map