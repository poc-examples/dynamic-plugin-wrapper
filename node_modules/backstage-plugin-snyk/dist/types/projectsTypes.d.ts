 ...
 * @enum {string}
 */
export declare enum PullRequestAssignmentSettingsTypeEnum {
    Auto = "auto",
    Manual = "manual"
}
 ...
 * @enum {string}
 */
export declare enum PullRequestsSettingsPolicyEnum {
    All = "all",
    OnlyNew = "only_new"
}
/**
 ...
 * @enum {string}
 */
export declare enum PullRequestsSettingsSeverityThresholdEnum {
    Low = "low",
    Medium = "medium",
    High = "high",
    Critical = "critical"
 ...
 * @enum {string}
 */
export declare enum RecurringTestsSettingsFrequencyEnum {
    Daily = "daily",
    Weekly = "weekly",
    Never = "never"
}
 ...
 * @enum {string}
 */
export declare enum ProjectAttributesBusinessCriticalityEnum {
    Critical = "critical",
    High = "high",
    Medium = "medium",
    Low = "low"
 ...
 * @enum {string}
 */
export declare enum ProjectAttributesEnvironmentEnum {
    Frontend = "frontend",
    Backend = "backend",
    Internal = "internal",
    External = "external",
 ...
 * @enum {string}
 */
export declare enum ProjectAttributesLifecycleEnum {
 ...
 * @enum {string}
 */
export declare enum ProjectAttributesStatusEnum {
    Active = "active",
    Inactive = "inactive"
}
...
//# sourceMappingURL=projectsTypes.d.ts.map